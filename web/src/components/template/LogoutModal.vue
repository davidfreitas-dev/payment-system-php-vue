              ...
              <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div class="mt-2">
                      <p class="text-sm text-gray-500 mx-10 sm:m-0">
...
.modal-actions button:first-child {
    @apply inline-flex w-full justify-center rounded-md border border-transparent bg-brand px-4 py-2 text-base font-medium text-white shadow-sm focus:outline-none sm:ml-3 sm:w-auto sm:text-sm
}
